...
class CycleGAN:
  def __init__(self,
    ...
    self.F = Generator('F', self.is_training, ngf=ngf, norm=norm, image_width=image_width, image_height=image_height)
  ...
  def model(self):
    X_reader = Reader(self.X_train_file, name='X',
        image_width=self.image_width, image_height=self.image_height, batch_size=self.batch_size)
